    ...
    $( document ).ready(function(){
        $.fn.wp_cfav = function( options ) {
            ...
            $( options.button ).click(function(){ 
                ...
                tb_show( 'WP Custom Favicon Upload an Image.', 'media-upload.php?referer=wp_cfav&type=image&TB_iframe=true&post_id=0', false );
        ...
        // Usage
        $( '.upload' ).wp_cfav(); // Use as default option.
    } );
} ( jQuery ) );